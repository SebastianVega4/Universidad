...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(list.jumping(list.findNode(5),1).getInfo().getDigit());
        System.out.println(list.jumping(list.findNode(9),4).getInfo().getDigit());
        System.out.println(list.jumping(list.findNode(3),10).getInfo().getDigit());
        System.out.println(list.jumping(list.findNode(2),3).getInfo().getDigit());
        System.out.println(list.jumping(list.findNode(6),7).getInfo().getDigit());
