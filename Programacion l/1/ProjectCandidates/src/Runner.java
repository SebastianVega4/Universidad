        ...
        try {
            ...
            do {
                String[] options = {"Total por candidatos", "Total por Municipios", "Total de votos", "Candidato Ganador",
                        "Ver resultados de un candidato", "Votos ordenados Descendentemente", "Generar Nuevos Numeros Ramdom", "SALIR"};
                ...
                } else if ("Votos ordenados Descendentemente".equals(seleccion)) {
                    JOptionPane.showMessageDialog(null, "Ordenados Descendentemente" + "\n" + elecciones.getDescendet());
