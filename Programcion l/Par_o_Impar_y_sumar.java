	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				JOptionPane.showMessageDialog(null, "Ingrese un numero valido \nvuelva a intentarlo", "ERROR", JOptionPane.QUESTION_MESSAGE);
			}
		} while (true);
